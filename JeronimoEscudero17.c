...
int main()
{
    ...
    do{ //Se inicia el ciclo do-while que se ejecuta mientras columna1 sea menor o igual a 9 e imprime las parejas de enteros
        if ( contador < 2 ){ 
            printf( "%i %i\n", columna1, columna2 );
            columna1++;
            contador++;
    ...
    while( columna1 <= 9 );//fin del do-while 

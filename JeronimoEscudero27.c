...
int main()
{
    int espaciosIniciales = 9, espaciosMedios = -1, fila = 1; //Se declaran las variables espaciosIniciales y espaciosMedios de tipo entero que almacenan la cantidad de espacios que se van a imprimir

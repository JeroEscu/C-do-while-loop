...
int main()
{
    int cantidadDeLetras = 13, cantidadDeEspacios = 33, fila = 1; //Se declaran las variables de tipo entero cantidadDeLetras y fila para almacenar la cantidad de letras que se imprimirán en cada fila y el número de fila en la que se encuentra el programa respectivamente

...
{
    float resultado = 1; //Se declara la variable resultado de tipo flotante que almacena el resultado del factorial
...
int main()
{
    ...
    do{ //Se ejecuta el ciclo mientras el contador sea menor a la cantidad de terminos
        printf( "%.0lf, ", round( Sumatoria( 0, contador, 100 ) ) );
        contador++;
    }

...
int main()
{
    ...
    do{ //Se inicia un ciclo do-while que se ejecuta mientras i sea menor o igual a 10 
        printf( "\nTabla del %i:\n", i );

        do{ //Se inicia un ciclo do-while que se ejecuta mientras j sea menor o igual a 10 e imprime las tablas de multiplicar
            printf( "%i x %i = %i\n", i, j, i * j );
            j++;
